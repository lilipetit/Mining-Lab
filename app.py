...
# 导入模块
from algorithms.clustering import render_kmeans_page
from algorithms.classification import render_classification_subpage
from algorithms.association import render_apriori_page
from algorithms.dimension_reduction import render_pca_page
from algorithms.regression import render_regression_page
from utils.coze_assistant import render_coze_sidebar, render_chat_interface, get_suggested_questions
from utils.data_loader import DATASET_INFO, load_csv_file, get_dataset_info
from utils.visualizer import download_plotly_image
...
def render_data_overview_page():
    ...
    with tab1:
        ...
        # 加载并显示数据
        from utils.data_loader import load_builtin_dataset
